...
class MyChildClass(MyClass):
    def hello(self):
         print "Those pesky child classes: "+ self.var1 + " " + self.var2 + " " + self.var3
...
# Some test code
    my_new_obj = MyChildClass('lunch', 'bunch', 'munch')
    print
    print my_new_obj.var1, my_new_obj.var2, my_new_obj.var3
    my_new_obj.hello()
    my_new_obj.not_hello()
    print
